...
namespace StudentDataAccessLayer
{
    ...
    {
        static string _connectionString = "Data Source=DESKTOP-75K1F0M;Initial Catalog=StudentsDB;Integrated Security=True;TrustServerCertificate=True";
...
//طبعا الافضل ال 
//DTOs
//توضع بطبقة مستقلة بحيث تصير عامة لكل الطبقات بدون ما نكسر المعمارية ونخلي طبقة ال 
//Api  
//توصل لطبقة الداتا اكسس